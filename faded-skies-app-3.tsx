            ...
            <div className="pb-24 bg-gradient-to-br from-gray-50 to-white min-h-screen">
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <button 
                    type="button"
                    onClick={() => alert('Live chat started! A support agent will be with you shortly.')}
                  ...
                  return (
                    <>
                      ...
                      <div className="p-6 max-h-96 overflow-y-auto">
                        <div className="space-y-4 mb-6">
                          {[
                            { name: 'Home', address: user.address, primary: true, type: 'home' },
                            { name: 'Work', address: '789 Business Ave, Austin, TX 78701', primary: false, type: 'work' },
                            { name: 'Friend\'s Place', address: '456 Party St, Austin, TX 78704', primary: false, type: 'other' }
                          ].map((addr, index) => (
                            <div key={index} className="bg-white border-2 border-gray-100 rounded-2xl p-5 hover:border-green-200 transition-colors">
                              <div className="flex items-center justify-between mb-3">
                                <div className="flex items-center space-x-3">
                        ...
                        <button type="button" className="w-full bg-gradient-to-r from-green-600 to-emerald-600 text-white py-4 rounded-2xl font-bold hover:from-green-700 hover:to-emerald-700 transition-all shadow-lg">
                          ➕ Add New Address
                        </button>
                      </div>
                    </>
                      ...
                      <div className="p-6 max-h-96 overflow-y-auto">
                        <div className="space-y-4">
                          ...
                          <div className="space-y-3">
                            <button 
                              type="button"
                              onClick={() => alert('Starting live chat with support agent...')}

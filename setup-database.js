...
const connectionString = 'postgresql://postgres.hdqbnhtimuynuypwouwf:1546738@Dc@aws-1-us-east-2.pooler.supabase.com:5432/postgres';
...
async function setupDatabase() {
  ...
  try {
    ...
    const schemaPath = path.join(__dirname, 'supabase-schema-user.sql');
    if (!fs.existsSync(schemaPath)) {
      throw new Error('Schema file not found. Please ensure supabase-schema-user.sql exists in the current directory.');
    }
